...
%This table is then used by the \LBP{} algorithm as the vertices labels weights (see \cref{app:LBP}).
\begin{algorithm}[H]
...
%The procedure for computing $p_v$ is described in \cref{alg:pv}.

By adding the pseudo-code
%\begin{tcolorbox}[colback=white,nobeforeafter]
	\begin{algorithmic}[0]
